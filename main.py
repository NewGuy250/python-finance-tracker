...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            ...
            # Format amount to 2 decimal places and handle NaN for description
            filtered_df["amount"] = filtered_df["amount"].map("{:.2f}".format)
            filtered_df["description"] = filtered_df["description"].replace({pd.NA: '', None: ''})
